...
return [
    ...
    'freshpay' => [
        ...
        'method_map' => [
            'mobile_money' => getenv('FRESHPAY_METHOD_MOBILE_MONEY') ?: 'mobile_money',
        ...
        'endpoints' => [
            ...
            'production' => [
                'initiate' => getenv('FRESHPAY_PROD_INITIATE_URL') ?: '',
                'status' => getenv('FRESHPAY_PROD_STATUS_URL') ?: '',
            ],
        ],
        'http' => [
            'timeout' => (int)(getenv('FRESHPAY_HTTP_TIMEOUT') ?: 20),
            'connect_timeout' => (int)(getenv('FRESHPAY_HTTP_CONNECT_TIMEOUT') ?: 10),
            'request_format' => getenv('FRESHPAY_REQUEST_FORMAT') ?: 'form',
        ],
        'callback' => [
            'signature_headers' => [
            ...
            'transaction_id_field' => getenv('FRESHPAY_CALLBACK_TRANSACTION_ID_FIELD') ?: 'TransactionId',
            'financial_institution_id_field' => getenv('FRESHPAY_CALLBACK_FINANCIAL_INSTITUTION_ID_FIELD') ?: 'FinancialInstitutionId',
            'decrypt_mode' => getenv('FRESHPAY_CALLBACK_DECRYPT_MODE') ?: 'plain_json',
            'decrypt_cipher' => getenv('FRESHPAY_CALLBACK_DECRYPT_CIPHER') ?: '',
