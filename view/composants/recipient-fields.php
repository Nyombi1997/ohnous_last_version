...
<fieldset class="recipient-fields admin-field--wide" id="recipient_fields">
    ...
    <label class="admin-field"><span>Référence interne KYC (facultatif)</span><input type="text" name="kyc_reference" maxlength="128" placeholder="VENDOR-KYC-42" value="<?= htmlspecialchars($recipientProfile['kyc_reference'] ?? '', ENT_QUOTES, 'UTF-8') ?>"></label>
</fieldset>
