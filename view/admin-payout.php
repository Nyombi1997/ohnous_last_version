<main class="admin-shell admin-detail-page">
    ...
    <section class="admin-detail-card payout-form-card"><div class="admin-detail-heading"><div><span class="admin-hero__eyebrow">FreshPay</span><h1>Nouveau PayOut</h1></div></div>
        <form id="admin_payout_form" class="admin-form-grid">
            ...
            <label class="admin-field"><span>Opérateur</span><select name="operator" required><option value="">Choisir</option><option value="airtel">Airtel</option><option value="orange">Orange</option><option value="mpesa">M-Pesa</option><option value="afrimoney">Afrimoney</option></select></label>
