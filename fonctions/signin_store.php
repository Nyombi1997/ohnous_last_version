<?php
    ...
    if (!validateHoneypot('inscription_boutique')) {
    ...
    else
    {
        ...
        $newStore = only_select("boutiques", "unique_id = '".addslashes($unique_id)."'", null, null);
        if($newStore)
        {
            ohnous_send_welcome_email_once($newStore, 'boutique');
        }
